<?php defined('_EXEC') or die; ?>
        ...
        <footer class="main_footer">
            ...
            <p>Copyright © 2021 <strong><?php echo Configuration::$web_page; ?></strong> <i class="fas fa-heart"></i> {$lang.development_by} <a href="https://codemonkey.com.mx" target="_blank">Code Monkey</a></p>
        </footer>
